  ...
  return (
    <DashboardLayout>
      <div className="h-full w-full">
        ...
        {currentIndex > 0 && (
          <div className="absolute bottom-48 md:bottom-56 left-1/2 -translate-x-1/2 z-[1000] flex items-center gap-4 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md px-4 py-2 rounded-2xl border border-white/20 dark:border-white/10 shadow-xl">
